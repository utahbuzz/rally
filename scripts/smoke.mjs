...
await page.waitForTimeout(250)
await page.locator('.float-icon', { hasText: '🎨' }).click()
await page.waitForTimeout(250)
await page.locator('.float-panel .swatch-row button').nth(6).click()
await page.waitForTimeout(250)
...
await page.waitForTimeout(200)
await page.locator('.float-seg.read').getByRole('button', { name: '1', exact: true }).click()
await page.waitForTimeout(200)
...
await page.waitForTimeout(250)
await page.locator('.float-note').fill('vs 2-high: work the seam')
await page.waitForTimeout(250)

...
/** Formation, hash, field position and Flip — the setup for one play. */
export function PlaySetup({ play }: { play: Play }) {
...
/** Sync, history, export and backup — actions on the playbook as a whole. */
    ...
    <header className="topbar">
      ...
      <div className="topbar-center">
        <input
          ...
          spellCheck={false}
        />
        {/* on a phone these live in the Setup sheet, reachable from the bottom bar */}
        {!compact && <PlaySetup play={play} />}
      </div>
